...
function ngremotemedia_ContentActionHandler( $module, $http, $objectID )
{
    ...
    if ( $module->isCurrentAction("CustomBrowse") )
    {
        ...
        eZContentBrowse::browse(
            array(
                ...
                'start_node' => '2', // @todo: parametrise this
                'cancel_page' => '/ngrm/multiupload', // @todo: make it smarter if possible
                'from_page' => "/ngrm/multiupload" ), // @todo: make it smarter if possible
                $module
        );
